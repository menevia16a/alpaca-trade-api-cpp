...
namespace alpaca {
    ...
    httplib::Headers headers(const Environment& environment, const std::string& userAgent) {
        return {
    ...
    std::pair<Status, Account> Client::getAccount(const std::string& userAgent) const {
        Account account;
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Get("/v2/account", headers(environment_, userAgent));
    ...
    std::pair<Status, AccountConfigurations> Client::getAccountConfigurations(const std::string& userAgent) const {
        AccountConfigurations account_configurations;
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Get("/v2/account/configurations", headers(environment_, userAgent));

        if (!resp) {
            return std::make_pair(Status(1, "Call to /v2/account/configurations returned an empty response"), account_configurations);
        }
    ...
    std::pair<Status, AccountConfigurations> Client::updateAccountConfigurations(const bool no_shorting, const std::string& dtbp_check, const std::string& trade_confirm_email, const bool suspend_trade, const std::string& userAgent) const {
        AccountConfigurations account_configurations;
        ...
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Patch("/v2/account/configurations", headers(environment_, userAgent), body, kJSONContentType);
    ...
    std::pair<Status, std::vector<std::variant<TradeActivity, NonTradeActivity>>> Client::getAccountActivity(const std::vector<std::string>& activity_types, const std::string& userAgent) const {
    ...
    std::pair<Status, Order> Client::getOrder(const std::string& id, const bool nested, const std::string& userAgent) const {
        Order order;
    ...
    std::pair<Status, Order> Client::getOrderByClientOrderID(const std::string& client_order_id, const std::string& userAgent) const {
        Order order;
    ...
    std::pair<Status, std::vector<Order>> Client::getOrders(const ActionStatus status, const int limit, const std::string& after, const std::string& until, const OrderDirection direction, const bool nested, const std::string& userAgent) const {
    ...
    std::pair<Status, Order> Client::submitOrder(const std::string& symbol, const int quantity, const OrderSide side, const OrderType type, const OrderTimeInForce tif, const std::string& limit_price, const std::string& stop_price, const bool extended_hours, const std::string& client_order_id, const OrderClass order_class, TakeProfitParams* take_profit_params, StopLossParams* stop_loss_params, const std::string& userAgent) const {
        Order order;
        rapidjson::StringBuffer s;
        rapidjson::Writer<rapidjson::StringBuffer> writer(s);
        ...
        auto body = s.GetString();
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Post("/v2/orders", headers(environment_, userAgent), body, kJSONContentType);
    ...
    std::pair<Status, Order> Client::replaceOrder(const std::string& id, const int quantity, const OrderTimeInForce tif, const std::string& limit_price, const std::string& stop_price, const std::string& client_order_id, const std::string& userAgent) const {
        Order order;
        rapidjson::StringBuffer s;
        s.Clear();
        rapidjson::Writer<rapidjson::StringBuffer> writer(s);
        ...
        auto url = "/v2/orders/" + id;
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Patch(url.c_str(), headers(environment_, userAgent), body, kJSONContentType);
    ...
    std::pair<Status, std::vector<Order>> Client::cancelOrders(const std::string& userAgent) const {
        std::vector<Order> orders;
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Delete("/v2/orders", headers(environment_, userAgent));
    ...
    std::pair<Status, Order> Client::cancelOrder(const std::string& id, const std::string& userAgent) const {
        Order order;
        httplib::Client client(environment_.getAPIBaseURL());
        auto url = "/v2/orders/" + id;
        auto resp = client.Delete(url.c_str(), headers(environment_, userAgent));
        ...
        if (resp->status == 204) {
            return getOrder(id, false, userAgent);
        }
    ...
    std::pair<Status, std::vector<Position>> Client::getPositions(const std::string& userAgent) const {
        std::vector<Position> positions;
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Get("/v2/positions", headers(environment_, userAgent));
    ...
    std::pair<Status, Position> Client::getPosition(const std::string& symbol, const std::string& userAgent) const {
        Position position;
    ...
    std::pair<Status, std::vector<Position>> Client::closePositions(const std::string& userAgent) const {
        std::vector<Position> positions;
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Delete("/v2/orders", headers(environment_, userAgent));
    ...
    std::pair<Status, Position> Client::closePosition(const std::string& symbol, const std::string& userAgent) const {
        Position position;
        httplib::Client client(environment_.getAPIBaseURL());
        auto url = "/v2/positions/" + symbol;
        auto resp = client.Delete(url.c_str(), headers(environment_, userAgent));
        ...
        if (resp->status == 204) {
            return getPosition(symbol, userAgent);
        }
    ...
    std::pair<Status, std::vector<Asset>> Client::getAssets(const AssetClass asset_class, const ActionStatus asset_status, const std::string& exchange, const std::string& userAgent) const {
    ...
    std::pair<Status, Asset> Client::getAsset(const std::string& symbol, const std::string& userAgent) const {
        Asset asset;
    ...
    std::pair<Status, Clock> Client::getClock(const std::string& userAgent) const {
        Clock clock;
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Get("/v2/clock", headers(environment_, userAgent));
    ...
    std::pair<Status, std::vector<Date>> Client::getCalendar(const std::string& start, const std::string& end, const std::string& userAgent) const {
    ...
    std::pair<Status, std::vector<Watchlist>> Client::getWatchlists(const std::string& userAgent) const {
        std::vector<Watchlist> watchlists;
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Get("/v2/watchlists", headers(environment_, userAgent));
    ...
    std::pair<Status, Watchlist> Client::getWatchlist(const std::string& id, const std::string& userAgent) const {
        Watchlist watchlist;
    ...
    std::pair<Status, Watchlist> Client::createWatchlist(const std::string& name, const std::vector<std::string>& symbols, const std::string& userAgent) const {
        Watchlist watchlist;
        rapidjson::StringBuffer s;
        s.Clear();
        rapidjson::Writer<rapidjson::StringBuffer> writer(s);
        ...
        auto body = s.GetString();
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Post("/v2/watchlists", headers(environment_, userAgent), body, kJSONContentType);
    ...
    std::pair<Status, Watchlist> Client::updateWatchlist(const std::string& id, const std::string& name, const std::vector<std::string>& symbols, const std::string& userAgent) const {
        Watchlist watchlist;
        rapidjson::StringBuffer s;
        s.Clear();
        rapidjson::Writer<rapidjson::StringBuffer> writer(s);
        ...
        auto url = "/v2/watchlists/" + id;
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Put(url.c_str(), headers(environment_, userAgent), body, kJSONContentType);
    ...
    Status Client::deleteWatchlist(const std::string& id, const std::string& userAgent) const {
        auto url = "/v2/watchlists/" + id;
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Delete(url.c_str(), headers(environment_, userAgent));
    ...
    std::pair<Status, Watchlist> Client::addSymbolToWatchlist(const std::string& id, const std::string& symbol, const std::string& userAgent) const {
        Watchlist watchlist;
        rapidjson::StringBuffer s;
        s.Clear();
        rapidjson::Writer<rapidjson::StringBuffer> writer(s);
        ...
        auto url = "/v2/watchlists/" + id;
        httplib::Client client(environment_.getAPIBaseURL());
        auto resp = client.Post(url.c_str(), headers(environment_, userAgent), body, kJSONContentType);
    ...
    std::pair<Status, Watchlist> Client::removeSymbolFromWatchlist(const std::string& id, const std::string& symbol, const std::string& userAgent) const {
        Watchlist watchlist;
    ...
    std::pair<Status, PortfolioHistory> Client::getPortfolioHistory(const std::string& period, const std::string& timeframe, const std::string& date_end, const bool extended_hours, const std::string& userAgent) const {
