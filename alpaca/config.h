...
namespace alpaca {
    ...
    */
    ...
    public:
        ...
        */
        explicit Environment(std::string api_key_id_env_var = "APCA_API_KEY_ID", std::string api_secret_key_env_var = "APCA_API_SECRET_KEY", std::string api_base_url_env_var = "APCA_API_BASE_URL", std::string api_data_url_env_var = "APCA_API_DATA_URL")
